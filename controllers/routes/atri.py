...
class Atri:
	...
	@property
	def navCont(self):
		self._getter_access_tracker["navCont"] = {}
		return self._navCont
	@navCont.setter
	def navCont(self, new_state):
		self._setter_access_tracker["navCont"] = {}
		global default_state
		self._navCont = Flex(new_state, default_state["navCont"])
